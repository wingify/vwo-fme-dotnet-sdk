...
using WingifyFmeSdk.Packages.SegmentationEvaluator.Core;
...
{
    /// <summary>
    /// WingifyBuilder class to build the Wingify instance.
    /// </summary>
    public class WingifyBuilder
    {
        private WingifyClient vwoClient;
        private readonly WingifyInitOptions options;
        ...
        public WingifyBuilder(WingifyInitOptions options)
        {
        ...
        public void SetWingifyClient(WingifyClient vwoClient)
        {
        ...
        public WingifyBuilder SetMaxRequestQueueCapacity()
        {
        ...
        /// </summary>
        /// <returns>The WingifyBuilder instance.</returns>
        public WingifyBuilder SetNetworkManager()
        {
        ...
        /// </summary>
        /// <returns>The instance of this builder.</returns>
        public WingifyBuilder SetSegmentation()
        {
        ...
        /// <summary>
        /// Sets the storage connector for the Wingify instance.
        /// </summary>
        /// <returns>The instance of this builder.</returns>
        public WingifyBuilder SetStorage()
        {
            if (options != null && options.Storage != null)
            {
                WingifyFmeSdk.Packages.Storage.Storage.Instance.AttachConnector(options.Storage);
            }
            return this;
        }

        /// <summary>
        /// Sets the settings manager for the Wingify instance.
        /// </summary>
        /// <returns>The instance of this builder.</returns>
        public WingifyBuilder SetSettingsManager()
        {
            if (options == null)
            {
                return this;
        ...
        /// <summary>
        /// Sets the logger for the Wingify instance.
        /// </summary>
        /// <returns>The instance of this builder.</returns>
        public WingifyBuilder SetLogger()
        {
            try
            {
        ...
        /// </summary>
        /// <returns>The instance of this builder.</returns>
        public WingifyBuilder InitPolling()
        {
        ...
        /// </summary>
        /// <returns>The instance of this builder.</returns>
        public WingifyBuilder InitBatching()
        {
        ...
        /// <summary>
        /// Initializes the usage stats for the Wingify instance.
        /// </summary>
        /// <returns>The instance of this builder.</returns>
        public WingifyBuilder InitUsageStats()
        {
