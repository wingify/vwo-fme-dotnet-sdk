...
namespace WingifyFmeSdk.Utils
{
    public static class GatewayServiceUtil
    {
         ...
         */
        public static string GetFromGatewayService(Dictionary<string, string> queryParams, string endpoint, WingifyContext context)
        {
            ...
            try
            {
                RequestModel request = new RequestModel(
                    ...
                    "GET",
                    UrlService.GetEndpointWithCollectionPrefix(endpoint, WingifyFmeSdk.Services.SettingsManager.GetInstance().isGatewayServiceProvided),
                    queryParams,
                    null,
                    null,
