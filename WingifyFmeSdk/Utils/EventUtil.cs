    ...
    public static class EventUtil
    {
        ...
        public static void SendSdkInitEvent(int? settingsFetchTime = null, int? sdkInitTime = null)
        {
            try
            {
                ...
                {
                    NetworkUtil.SendEvent(properties, payload, EventEnum.SDK_INIT_EVENT.GetValue());
                }
            }
            catch (Exception ex)
            {
        ...
        public static void SendSDKUsageStatsEvent(int usageStatsAccountId)
        {
            try
            {
                ...
                {
                    NetworkUtil.SendEvent(properties, payload, EventEnum.USAGE_STATS_EVENT.GetValue());
                }
            }
            catch (Exception ex)
            {
