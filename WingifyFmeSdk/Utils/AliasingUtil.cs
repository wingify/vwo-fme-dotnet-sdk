        ...
        public static string GetAlias(string userId)
        {
            try
            {
                ...
                var request = new RequestModel(
                    ...
                    "GET",
                    UrlService.GetEndpointWithCollectionPrefix(UrlEnum.GET_ALIAS.GetUrl(), WingifyFmeSdk.Services.SettingsManager.GetInstance().isGatewayServiceProvided),
                    queryParams,
                    null,
                    null,
        ...
        public static string SetAlias(string userId, string aliasId)
        {
            try
            {
                ...
                var request = new RequestModel(
                    SettingsManager.GetInstance().hostname,
                    "POST",
                    UrlService.GetEndpointWithCollectionPrefix(UrlEnum.SET_ALIAS.GetUrl(), WingifyFmeSdk.Services.SettingsManager.GetInstance().isGatewayServiceProvided),
                    queryParams,
                    requestBody,
                    null,
                    SettingsManager.GetInstance().Protocol,
