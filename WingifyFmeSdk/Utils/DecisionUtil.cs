...
using WingifyFmeSdk.Packages.DecisionMaker;
using static WingifyFmeSdk.Utils.CampaignUtil;
using WingifyFmeSdk.Packages.SegmentationEvaluator.Core;
using WingifyFmeSdk.Decorators;
...
namespace WingifyFmeSdk.Utils
{
    public static class DecisionUtil
    {
        ...
        public static Variation EvaluateTrafficAndGetVariation(Settings settings, Campaign campaign, WingifyContext context)
        {
        ...
        private static Dictionary<string, object> CheckCampaignWhitelisting(Campaign campaign, WingifyContext context)
        {
        ...
        private static Dictionary<string, object> EvaluateWhitelisting(Campaign campaign, WingifyContext context)
        {
