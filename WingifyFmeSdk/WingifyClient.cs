...
using WingifyFmeSdk.Models.Schemas;
using System.Linq;
...
namespace WingifyFmeSdk
{
    ...
    {
        private static WingifyClient vwoClientInstance;
        ...
        /// <summary>
        /// Constructor to initialize the WingifyClient
        /// </summary>
        /// <param name="settings">Settings JSON string</param>
        /// <param name="options">WingifyInitOptions object</param>
        /// <returns> WingifyClient object</returns>
        public WingifyClient(string settings, WingifyInitOptions options, WingifyBuilder vwoBuilder)
        {
            try
            {
        ...
        /// <summary>
        /// Static method to get the WingifyClient instance
        /// </summary>
        /// <returns>WingifyClient instance</returns>
        public static WingifyClient GetInstance()
        {
        ...
        public GetFlag GetFlag(string featureKey, WingifyContext context)
        {
        ...
        private Dictionary<string, bool> Track(string eventName, WingifyContext context, Dictionary<string, object> eventProperties)
        {
        ...
        /// <param name="eventProperties">Event properties to be sent for the event</param>
        /// <returns>Map containing the event name and its status</returns>
        public Dictionary<string, bool> TrackEvent(string eventName, WingifyContext context, Dictionary<string, object> eventProperties)
        {
        ...
        /// <param name="context">User context</param>
        /// <returns>Map containing the event name and its status</returns>
        public Dictionary<string, bool> TrackEvent(string eventName, WingifyContext context)
        {
        ...
        /// <param name="context">User context</param>
        public void SetAttribute(Dictionary<string, dynamic> attributes, WingifyContext context)
        {
            string apiName = "setAttribute";
            try
            {
        ...
        public bool SetAlias(object contextOrUserId, string aliasId)
        {
            ...
            try
            {
                ...
                else if (contextOrUserId is WingifyContext)
                {
                    var ctx = contextOrUserId as WingifyContext;
