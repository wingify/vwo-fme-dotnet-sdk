...
namespace WingifyFmeSdk.Models.Request
{
    public class Props
    {
        [JsonProperty("vwo_sdkName", NullValueHandling = NullValueHandling.Ignore)]
        public string VwoSdkName { get; set; }

        [JsonProperty("vwo_sdkVersion", NullValueHandling = NullValueHandling.Ignore)]
        public string VwoSdkVersion { get; set; }

        [JsonProperty("vwo_fs_environment", NullValueHandling = NullValueHandling.Ignore)]
