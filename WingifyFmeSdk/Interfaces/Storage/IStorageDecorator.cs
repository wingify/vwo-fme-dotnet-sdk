...
namespace WingifyFmeSdk.Interfaces.Storage
{
    public interface IStorageDecorator
    {
        ...
        Dictionary<string, object> GetFeatureFromStorage(string featureKey, WingifyContext context, StorageService storageService);
    }
}
