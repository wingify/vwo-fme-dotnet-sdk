...
using static WingifyFmeSdk.Utils.FunctionUtil;
using WingifyFmeSdk.Utils; // Ensure this namespace is included
...
namespace WingifyFmeSdk.Api
{
    ...
    {
        public static GetFlag GetFlag(string featureKey, Settings settings, WingifyContext context, HooksManager hookManager)
        {
