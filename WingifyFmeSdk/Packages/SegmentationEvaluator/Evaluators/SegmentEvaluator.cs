...
namespace WingifyFmeSdk.Packages.SegmentationEvaluator.Evaluators
{
    public class SegmentEvaluator
    {
        ...
        public bool CheckInUserStorage(Settings settings, string featureKey, WingifyContext context)
        {
            ...
            try
            {
                ...
                var storedData = JsonConvert.DeserializeObject<WingifyFmeSdk.Models.Storage>(storageMapAsString);
