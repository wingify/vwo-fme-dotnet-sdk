...
using WingifyFmeSdk.Packages.SegmentationEvaluator.Enums;
using WingifyFmeSdk.Services;
using WingifyFmeSdk.Utils;
using WingifyFmeSdk.Packages.SegmentationEvaluator.Utils;
using System.Linq;
using Newtonsoft.Json;
using WingifyFmeSdk.Packages.Logger.Core;
using WingifyFmeSdk.Enums;
namespace WingifyFmeSdk.Packages.SegmentationEvaluator.Evaluators
{
    public class SegmentOperandEvaluator
    {
        public bool EvaluateCustomVariableDSL(JToken dslOperandValue, Dictionary<string, object> properties, WingifyContext context)
        {
        ...
        public bool EvaluateUserAgentDSL(string dslOperandValue, WingifyContext context)
        {
        ...
        public bool EvaluateStringOperandDSL(JToken dslOperandValue, WingifyContext context, SegmentOperatorValueEnum operandType)
        {
        ...
        private string GetTagValueForOperandType(WingifyContext context, SegmentOperatorValueEnum operandType)
        {
            switch (operandType)
            {
        ...
        private string GetBrowserVersionFromContext(WingifyContext context)
        {
        ...
        private string GetOsVersionFromContext(WingifyContext context)
        {
            if (context.Vwo?.UserAgent == null || context.Vwo.UserAgent.Count == 0)
            {
                return null;
