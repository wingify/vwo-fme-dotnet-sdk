...
namespace WingifyFmeSdk.Packages.Logger
{
    public class LogMessageBuilder
    {
        ...
        public LogMessageBuilder(Dictionary<string, object> loggerConfig, Dictionary<string, object> transport)
        {
            ...
            this.prefix = loggerConfig.ContainsKey("prefix") ? loggerConfig["prefix"].ToString() : (WingifyFmeSdk.Utils.BrandContext.IsViaVwo() ? "VWO-SDK" : "Wingify-SDK");
