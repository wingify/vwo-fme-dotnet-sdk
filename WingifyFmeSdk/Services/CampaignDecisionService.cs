...
namespace WingifyFmeSdk.Services
{
    public class CampaignDecisionService
    {
        ...
        public bool IsUserPartOfCampaign(WingifyContext context, Campaign campaign)
        {
        ...
        /// <param name="campaign"></param>
        public Variation BucketUserToVariation(WingifyContext context, string accountId, Campaign campaign)
        {
            var userId = context.Id;
            var bucketingId = CampaignUtil.GetBucketingIdForUser(context);
        ...
        /// <param name="campaign"></param>
        /// <param name="context"></param>
        public bool GetPreSegmentationDecision(Campaign campaign, WingifyContext context)
        {
        ...
        /// <param name="campaign"></param>
        /// <returns></returns>
        public Variation GetVariationAllotted(WingifyContext context, string accountId, Campaign campaign)
        {
